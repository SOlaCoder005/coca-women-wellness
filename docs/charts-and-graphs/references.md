...
Below are a list of references that has aided the programmer's knowledgeunderstanding of coding principles which has helped build the Coca Women Wellness website. 
